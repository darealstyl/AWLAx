...
namespace NullSave.GDTK
{
    ...
    [AutoDoc("The Math Solver allows you to supply a formula and receive the parsed result.")]
    public class MathSolver
    {
        ...
        [AutoDoc("Get list of built-in functions")]
        ...
        [AutoDoc("Get/Set handler for unknown functions")]
        public MathFunctionSolver unknownFunctionHandler { get; set; }

        [AutoDoc("Get/Set handler for unknown values")]
        ...
        [AutoDoc("Check if a condition is true")]
        [AutoDocParameter("Condition to evaluate")]
        ...
        [AutoDoc("Parse an expression")]
        [AutoDocParameter("Exression to arse")]
        ...
        [AutoDoc("Split an expression into compponents")]
        [AutoDocParameter("Expression to split")]
        [AutoDocParameter("Remove math symbols")]
        [AutoDocParameter("Remove commands")]
        ...
        private string HandlePEMDAS(string equation, char op)
        {
            ...
            while (true)
            {
                ...
                {
                    StringExtensions.LogError("MathSolver.cs", "HandlePEMDAS", "Cannot parse '" + equation + "'");
                    throw;
                }
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        StringExtensions.LogError("MathSolver.cs", "SolveFunctions", "Unknown function '" + fnc + "' in " + value);
                        return value;
                    }
                }
            }
        ...
        private double SolveMath(string value)
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if (open >= 0)
                    {
                        ...
                        if (close < 0)
                        {
                            StringExtensions.LogError("MathSolver.cs", "SolveMath", "Invalid expression: " + value);
                            return 0;
                        }
                        else
                        {
            ...
            {
                StringExtensions.LogError("MathSolver.cs", "SolveMath", ex.Message);
            }
