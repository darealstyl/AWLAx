...
namespace NullSave.GDTK
{
    ...
    [AutoDoc("This class contains methods that assist with UI actions.")]
    public static class UIExtensions
    {

        [AutoDoc("Ensure an item is visible within a scroll rect by adjust scrollbar positions as needed")]
        [AutoDocParameter("ScrollRect containing item")]
        [AutoDocParameter("Item to ensure is visible")]
