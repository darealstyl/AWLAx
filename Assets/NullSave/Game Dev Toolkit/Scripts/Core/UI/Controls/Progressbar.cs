...
namespace NullSave.GDTK
{
    ...
    public class Progressbar : MonoBehaviour
    {
        ...
        [AutoDoc("Mode used to fill progressbar.")]
        ...
        [AutoDoc("Graphic used to display fill")]
