...
namespace NullSave.GDTK
{
    ...
    public class InlineList : Selectable
    {
        ...
        [Tooltip("Event raised whenever selection changes.")] public SelectedIndexChanged onIndexChanged;
        ...
        [AutoDoc("Check if pointer is down on control.")]
        private bool pointerDown { get; set; }

        [AutoDoc("Check if pointer is over control.")]
        private bool pointerInside { get; set; }

        [AutoDoc("Gets/Sets the selected index.")]
        ...
        [AutoDoc("Gets the text for the selected index.")]
...
#pragma warning restore CS0114 // Member hides inherited member; missing override keyword
        ...
        [AutoDoc("Adds a new option to the end of the list.")]
        ...
        [AutoDoc("Adds a list of options to the end fo the list.")]
        ...
        [AutoDoc("Remove all options from the list.")]
        public void Clear()
        {
            selectedIndex = -1;
            options.Clear();
