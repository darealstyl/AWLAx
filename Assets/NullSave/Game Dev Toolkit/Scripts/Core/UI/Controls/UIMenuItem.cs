...
namespace NullSave.GDTK
{
    ...
    public class UIMenuItem : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler, ISubmitHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        [AutoDoc("True if pointer is over control")]
        public bool hasPointer { get; private set; }

        [AutoDoc("Determine if control is interactable")]
        ...
        [AutoDoc("Returns the UIMenu that owns this control")]
        public UIMenu parent { get; private set; }

        [AutoDoc("True if pointer is pressed over control")]
        public bool pointerDown { get; private set; }

        [AutoDoc("True if control is selected")]
        ...
        [AutoDoc("Gets/Sets the text on the control")]
        public string text
        {
        ...
        [AutoDoc("Force the control to refresh its UI")]
        public void Refresh()
        {
            UpdateState();
        }
