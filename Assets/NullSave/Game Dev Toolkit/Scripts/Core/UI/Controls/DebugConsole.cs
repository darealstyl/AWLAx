...
namespace NullSave.GDTK
{
    ...
    public class DebugConsole : MonoBehaviour, IBroadcastReceiver
    {
        ...
        [AutoDoc("Animator used to control show/hide animations.")]
        ...
        [AutoDoc("Toggle the show/hide state of the console.")]
