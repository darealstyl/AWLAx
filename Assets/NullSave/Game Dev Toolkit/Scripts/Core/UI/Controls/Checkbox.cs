...
namespace NullSave.GDTK
{
    ...
    public class Checkbox : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        ...
        [AutoDoc("Gets/Sets the on/off state.")]
        public bool isOn
        {
            get { return m_IsOn; }
            set
        ...
        [AutoDoc("Gets/Sets text. On set text is localized if the *localize* flag is set")]
        public string text
        {
        ...
        [AutoDoc("Returns the TextMeshPro object displaying text")]
        public TextMeshProUGUI textMeshPro
        {
            get { return target; }
        }

        [AutoDoc("Returns the text supplied before localization")]
