...
namespace NullSave.GDTK
{
    ...
    [AutoDoc("Provides 1d navigational input")]
    [Serializable]
    public class UI1DNav
    {
        ...
        [Tooltip("Ignore modal blocking")] public bool ignoreModal;
        ...
        {
            if (lockInput || (!ignoreModal && InterfaceManager.IsBlockedByModal(gameObject))) return;
