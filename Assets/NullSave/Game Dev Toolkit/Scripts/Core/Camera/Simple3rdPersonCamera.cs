...
{
    [AutoDoc("Provides a basic third person camera for quick prototyping")]
    ...
    public class Simple3rdPersonCamera : MonoBehaviour
    {
        ...
        // Camera State
        [Tooltip("Default distance from target")] public float defaultDistance = 1.5f;
        [Tooltip("Maximum distance from target")] public float maxDistance = 3f;
        [Tooltip("Minimum distance from target")] public float minDistance = 0.5f;
        [Tooltip("Y offset from target")] public float height = 0f;
        [Tooltip("Follow smoothing")] public float smoothFollow = 10f;
        [Tooltip("Rotation smoothing")] public float smoothRotation = 10f;
        [Tooltip("Mouse X axis sensitivity")] public float xMouseSensitivity = 3f;
        [Tooltip("Mouse Y axis sensitivity")] public float yMouseSensitivity = 3f;

        [Tooltip("Culling height")] public float cullingHeight = 0.2f;
        [Tooltip("Culling minimum distance")] public float cullingMinDist = 0.1f;
        [Tooltip("State smoothing")] public float stateSmoothing = 6f;

        // Camera
        [Tooltip("Follow target")] public Transform target;

        // Input
        [Tooltip("Horizontal input axis")] public string inputHoriz = "Mouse X";
        [Tooltip("Vertical input axis")] public string inputVert = "Mouse Y";
        [Tooltip("Culling layer")] public LayerMask cullingLayer = 1 << 0;
        [Tooltip("Clip margin")] public float clipPlaneMargin;
        [Tooltip("Height radius")] public float checkHeightRadius;
        ...
        [AutoDoc("Gets/Sets input locked state")]
