...
namespace NullSave.GDTK
{
    ...
    [AutoDoc("This component allows you to issue broadcasts from the UI at runtime. The terminal also displays all messages sent over both the public channel as well as named channels.")]
    public class BroadcasterTerminal : MonoBehaviour, IBroadcastReceiver
    {
        ...
        private void ExecuteCommand(object sender, List<string> parts)
        {
            // Process
            if (parts.Count == 1)
            {
